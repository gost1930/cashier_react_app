            ...
            <div className='flex flex-row justify-around gap-1 mb-4'>
                <div className="flex items-center">
                    ...
                    <input 
                        ...
                        name="type" 
                        className=""
                        checked={formik.values.type === 'عميل'} 
                        onChange={() => formik.setFieldValue('type', 'عميل')}
                    />
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <input 
                        ...
                        name="type" 
                        className=""
                        checked={formik.values.type === 'مورد'} 
                        onChange={() => formik.setFieldValue('type', 'مورد')}
                    />
                </div>
            </div>
                ...
                <div className={`${formik.values.type === 'مورد' ? 'hidden' : ''} grid grid-cols-3 gap-6 mb-4 border-t border-gray-400`}>
                    <div>
