      ...
      <div className="py-4 px-6">
        ...
        action={
          <div className='flex items-center gap-x-2'>
            <a className='text-blue-500 cursor-pointer text-2xl'><IoPrintOutline /></a>
            <a href="#" className="text-red-500 cursor-pointer text-2xl"><MdDeleteOutline /></a>
            </div>
            }
        />
      </div>
